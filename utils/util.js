...
//   content = content.replace(/\<image/gi, '<image style="width:100% !important;height:auto !important;margin:0;display:flex;" ')
...
// //   } else { // 没有userId
// //     // #ifdef H5 || MP-WEIXIN
// //     if (uni.getStorageSync('appType') == constant.appType.MP || uni.getStorageSync('appType') == constant.appType.MINI) {
// //       uni.navigateTo({
